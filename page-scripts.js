...
$('#ctrl-is_below_poority_line').on('change', function(){ 
	//do something like 
	//$(this).hide(); 
	//$(#anotherfieldid).show();
	...
	if ($(this).val() == 1)
	{
	    $('#ctrl-poority_certificate_no').parents(".form-group").show();
	    document.getElementById("2").disabled = true;
	 }
	else
	{
	 $('#ctrl-poority_certificate_no').parents(".form-group").hide();
	  $('#ctrl-poority_certificate_no').val('NULL');
	 //alert($(this).val()); 
	}
});
$('#ctrl-gharkul_yojana').on('change', function(){ 
	//do something like 
	//$(this).hide(); 
	//$(#anotherfieldid).show();
	//var ctrlVal = $(this).val();
	...
	{
	// alert($(this).val()); 
	   // $('#ctrl-disabiity_percentage').parents(".form-group").show();
	    $('#ctrl-if_not_applied').parents(".form-group").show();
	   document.getElementById("2").disabled = true;
	}
	else
	{
	 //$('#ctrl-disabiity_percentage').parents(".form-group").hide();
	   $('#ctrl-if_not_applied').parents(".form-group").hide();
	 //alert($(this).val()); 
	}
});
$('#ctrl-compost').on('change', function(){ 
	//do something like 
	//$(this).hide(); 
	//$(#anotherfieldid).show();
	//var ctrlVal = $(this).val();
...
$('#ctrl-solar').on('change', function(){ 
	...
	// alert($(this).val()); 
	   // $('#ctrl-disabiity_percentage').parents(".form-group").show();
	    $('#ctrl-solar_type').parents(".form-group").show();
	   document.getElementById("2").disabled = true;
	}
	else
	{
	 //$('#ctrl-disabiity_percentage').parents(".form-group").hide();
	   $('#ctrl-solar_type').parents(".form-group").hide();
	 //alert($(this).val()); 
	}
});
$('#ctrl-are_you_disable').on('change', function(){ 
	//do something like 
	//$(this).hide(); 
	//$(#anotherfieldid).show();
	//var ctrlVal = $(this).val();
	...
	{
	    $('#ctrl-disabiity_percentage').parents(".form-group").show();
	    $('#ctrl-disability_type').parents(".form-group").show();
	   document.getElementById("2").disabled = true;
	}
	else
	{
	 $('#ctrl-disabiity_percentage').parents(".form-group").hide();
	   $('#ctrl-disability_type').parents(".form-group").hide();
	 //alert($(this).val()); 
	}
});
$('#ctrl-artha_yojana').on('change', function(){ 
	//do something like 
	//$(this).hide(); 
	//$(#anotherfieldid).show();
	//var ctrlVal = $(this).val();
	...
	if ($(this).val() == 1)
	{
	 //alert($(this).val()); 
	  //  $('#ctrl-disabiity_percentage').parents(".form-group").show();
	    $('#ctrl-artha_yojana_type').parents(".form-group").show();
	   document.getElementById("2").disabled = true;
	}
	else
	{
	 //$('#ctrl-disabiity_percentage').parents(".form-group").hide();
	   $('#ctrl-artha_yojana_type').parents(".form-group").hide();
	 //alert($(this).val()); 
	}
});
});
